#ifndef vtkControlPointArray_h
#define vtkControlPointArray_h
...
public:
  ...
  static vtkControlPointArray* New();
  virtual void PrintSelf(ostream& os, vtkIndent indent);

  void InitializeArray(vtkDataArray* controlPoints);
...
private:
  vtkControlPointArray(const vtkControlPointArray&); // not implemented
  void operator = (const vtkControlPointArray&); // not implemented

  double TempDoubleArray[3];
  vtkDataArray* ControlPoints;
};

#include "vtkControlPointArray.txx"
